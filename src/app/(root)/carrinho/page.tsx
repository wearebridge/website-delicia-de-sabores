  ...
  async function onSubmit (values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      setTimeout(async () => {
        ...
        const message = encodeURIComponent(`Olá, acabei de fazer o pedido de ${data.doc.products.length} produto${data.doc.products.length > 1? 's' : ''}. O valor total foi de R$${(data.doc.totalProductsPrice + deliveryFee).toFixed(2)}, para ser entregue em: ${data.doc.adress}. Gostaria de finalizar o pagamento via ${data.doc.paymentMethod}`);
